...
### create some plots with the output.
  plot(out[,1],out[,2],type="l",col="forestgreen", ylim = c(0,8500), lwd = 5, cex.lab = 1.5,
       cex.axis = 1.5, xlab = "Days", ylab = "Number of susceptible snails")
  lines(out[,1],out2[,2],col="darkgoldenrod", lwd = 5)
  
  plot(out[,1],out[,3],type="l",col="forestgreen", ylim = c(0,8000), lwd = 5, cex.lab = 1.5,
       cex.axis = 1.5, xlab = "Days", ylab = "Number of exposed snails")
  lines(out[,1],out2[,3],col="darkgoldenrod", lwd = 5)
  
  plot(out[,1],out[,4],type="l",col="forestgreen", ylim = c(0,1600), lwd = 5, cex.lab = 1.5,
       cex.axis = 1.5, xlab = "Days", ylab = "Number of infected snails")
  lines(out[,1],out2[,4],col="darkgoldenrod", lwd = 5)
  
  plot(out[,1],out[,5],type="l",col="forestgreen", ylim = c(0,45), lwd = 5, cex.lab = 1.5,
       cex.axis = 1.5, xlab = "Days", ylab = "Relative worm burden")
  lines(out[,1],out2[,5],col="darkgoldenrod", lwd = 5)
  
#old code for proportional plots
Sout <- out2[,2]/out[,2]
Eout <- out2[,3]/out[,3]
Iout <- out2[,4]/out[,4]
Wout <- out2[,5]/out[,5]
